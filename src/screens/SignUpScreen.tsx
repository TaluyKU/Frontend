...
import { Button, Checkbox, View, Dialog, PanningProvider, Text } from 'react-native-ui-lib';
    ...
    <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollView}>
      <View useSafeArea>
        <View style={styles.container}>
          <CustomInputText placeholder={'ชื่อที่ต้องการให้แสดง'} setValue={setName} />
          <CustomInputText placeholder={'ชื่อผู้ใช้'} setValue={setEmail} />
          <CustomInputText placeholder={'รหัสผ่าน'} setValue={setpassword} secureTextEntry={true} />
          <CustomInputText
          ...
          <Button
            ...
            onPress={() => {
              ...
              register(name, email, password, confirmPassword).catch((error) => {
                console.log(error);
                setDialogVisible(true);
